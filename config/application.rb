...
module Chatwoot
  class Application < Rails::Application
    ...
    # Enterprise edition is not bundled in this open-source build. The paths are
    # only wired up when the (absent) enterprise/ directory is present, so the
    # community edition boots cleanly without it. See ChatwootApp.enterprise?.
